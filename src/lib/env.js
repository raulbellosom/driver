export const env = {
  ...
  // Fleet Collections
  COLLECTION_VEHICLE_BRANDS_ID: import.meta.env
    .VITE_APPWRITE_COLLECTION_VEHICLE_BRANDS_ID,
  COLLECTION_VEHICLE_TYPES_ID: import.meta.env
    .VITE_APPWRITE_COLLECTION_VEHICLE_TYPES_ID,
  COLLECTION_VEHICLE_MODELS_ID: import.meta.env
    .VITE_APPWRITE_COLLECTION_VEHICLE_MODELS_ID,
  COLLECTION_VEHICLES_ID: import.meta.env.VITE_APPWRITE_COLLECTION_VEHICLES_ID,
  COLLECTION_VEHICLE_DOCUMENTS_ID: import.meta.env
    .VITE_APPWRITE_COLLECTION_VEHICLE_DOCUMENTS_ID,
  COLLECTION_INSURANCES_ID: import.meta.env
    .VITE_APPWRITE_COLLECTION_INSURANCES_ID,
  COLLECTION_VEHICLE_ODOMETERS_ID: import.meta.env
    .VITE_APPWRITE_COLLECTION_VEHICLE_ODOMETERS_ID,
  COLLECTION_RECHARGE_CARDS_ID: import.meta.env
    .VITE_APPWRITE_COLLECTION_RECHARGE_CARDS_ID,
  COLLECTION_RECHARGE_MOVEMENTS_ID: import.meta.env
    .VITE_APPWRITE_COLLECTION_RECHARGE_MOVEMENTS_ID,
  COLLECTION_DRIVERS_ASSIGNMENTS_ID: import.meta.env
    .VITE_APPWRITE_COLLECTION_DRIVERS_ASSIGNMENTS_ID,
